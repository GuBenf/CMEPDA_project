...
public:
  ...
  void set_t_1(G4double i){det_1 = i;}
  void set_t_2(G4double i){det_2 = i;}
  void set_t_3(G4double i){det_3 = i;}
  void set_t_4(G4double i){det_4 = i;}
  void set_t_5(G4double i){det_5 = i;}
  void set_t_6(G4double i){det_6 = i;}
  //getters
